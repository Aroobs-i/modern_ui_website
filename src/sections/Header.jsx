    ...
    <header className='fixed top-0 left-0 z-50 w-full py-10'>
        <div className='container flex h-14 items-center max-lg:px-5'>
            ...
            className='max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 
                        max-lg:overflow-hidden sidebar-before'
            >
                <nav className='max-lg:relative max-lg:z-2 max-lg:my-2'>
                ...
                <div 
                className='lg:hidden absolute top-1/2 block left-0 w-[960px] h-[380px] translate-x-[-290px] -translate-y-1/2 rotate-90'
                >
                    <img 
        ...
        <button 
        className='lg:hidden z-2 size-10 rounded-full border-2 border-s4/25 flex justify-center'
