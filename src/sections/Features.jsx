                    ...
                    <ul className='relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden'>
                        ...
                        {details.map(({ id, icon, title }) => (
                            <li key={id} className='relative pt-16 px-4 pb-14'>
                                ...
                                <div className='flex items-center justify-center mx-auto mb-3 border-2 border-s2 hover:border-s4
                                rounded-full transition-all duration-500 shadow-500 size-20'
                                >
                                    <img 
                                    src={icon} 
                                    alt={title} 
